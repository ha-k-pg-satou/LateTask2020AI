...
void Engine::DrawFan(Vec2 center_pos, float arc_degree, float length, float rotate_degree, DWORD color)
{
	m_Instance->GetGraphics()->DrawFan(center_pos, arc_degree, length, rotate_degree, color);
}
